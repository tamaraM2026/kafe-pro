  ...
  return (
    <section className="py-20">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <h1 className="mt-4 font-display text-5xl md:text-6xl text-burgundy text-center">Say hello.</h1>
        ...
        <form
          ...
          className="mt-12 bg-card border border-border rounded-3xl p-8 space-y-5 shadow-sm"
        >
          <div className="grid md:grid-cols-2 gap-5">
            <label className="block">
              <span className="text-sm text-foreground/75">Name</span>
              <input required className="mt-2 w-full rounded-xl border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-terracotta" />
            </label>
            <label className="block">
              <span className="text-sm text-foreground/75">Email</span>
              <input required type="email" className="mt-2 w-full rounded-xl border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-terracotta" />
            </label>
          </div>
          <label className="block">
            <span className="text-sm text-foreground/75">Message</span>
            <textarea required rows={5} className="mt-2 w-full rounded-xl border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-terracotta" />
          </label>
          <button type="submit" className="w-full md:w-auto px-7 py-4 rounded-full bg-burgundy text-primary-foreground hover:opacity-90 transition">
            Send message →
          </button>
          {sent && <p className="text-sage text-sm">Thanks — we'll be in touch soon.</p>}
        </form>
