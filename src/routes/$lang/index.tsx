          ...
          <div>
            ...
            <Animate delay={300}>
              <div className="mt-10 flex flex-wrap gap-4">
                <Link to={"/$lang/events/$slug"} params={{ lang, slug: "building-without-a-map" }} className="px-7 py-4 rounded-full bg-gradient-to-r from-sage to-sage/80 text-sage-foreground hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-sage/20">
                  {t.common.reserve}
                </Link>
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <Animate delay={100}>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link to={"/$lang/events/$slug"} params={{ lang, slug: "building-without-a-map" }} className="px-7 py-4 rounded-full bg-gradient-to-r from-sage to-sage/80 text-sage-foreground hover:scale-[1.02] active:scale-[0.98] transition-all">
                {t.common.reserve}
              </Link>
