...
export const en: Translations = {
  ...
  events: {
    hero: {
      ...
      heading: "One evening a month. One real conversation.",
      lead: "Kafe con Propósito is now a single monthly flagship evening — a featured woman’s story, real conversation, and a discussion built for professional women, entrepreneurs, and expats in Central Bohemia. No pitches, no pressure. Just women navigating ambition, identity, and everything in between — together.",
      secondaryCta: "See the season calendar",
      metaLine: "Second Thursday of every month · 18:00–20:00 · English · October 2026 – May 2027",
    },
    whatsNew: {
      eyebrow: "What’s new",
      heading: "A new format, built for how our community actually shows up",
      intro: "We’re moving to one flagship evening a month. Same spirit, sharper focus: fewer dates, more depth. Each edition follows the same rhythm:",
    },
    rhythm: {
      oneCup: {
        title: "One Cup, One Story",
        text: "A featured woman shares her story — a career pivot, a business built without a map, a transition she navigated in her own words.",
      },
      networking: {
        title: "Networking, unscripted",
        text: "Real conversation over coffee — no name-tag small talk, no pitching.",
      },
      discussion: {
        title: "A discussion or workshop",
        text: "One topic, explored together — chosen to speak directly to professional and entrepreneurial women.",
      },
      dinner: {
        title: "Optional dinner",
        text: "Stay on for dinner at a rotating venue, priced at cost — join the conversation for the evening, or make a night of it.",
      },
    },
    detailsEyebrow: "The details",
    detailsHeading: "Everything you need to know",
    seasonDetails: [
      { label: "When", value: "Second Thursday of the month, 18:00–20:00" },
      { label: "Language", value: "English" },
      { label: "Where", value: "Rotating venues across Central Bohemia — announced with each edition" },
      { label: "Season", value: "October 2026 – May 2027 (7 editions)" },
      { label: "Ticket", value: "490 CZK · early-bird 390 CZK for the first 15 RSVPs at the October 8 launch" },
      { label: "Dinner", value: "Optional add-on, priced at cost" },
    ],
    calendarEyebrow: "The season",
    calendarHeading: "The 2026–2027 season",
    calendarIntro: "Seven evenings, seven themes — chosen for women building careers, businesses, and lives without a template to follow.",
    viewDetailsCta: "View details →",
    launchTag: "Launch",
    closeTag: "Season close",
    ctaBand: {
      eyebrow: "Save your seat",
      heading: "Spaces are limited to keep the conversation real.",
      seasonBody: "Reserve your seat for the next edition, or join us for the season.",
      editionBody: "Reserve your seat for {title}.",
      seeOtherDates: "See other dates",
      emailNote: "RSVP right here on the page, we will confirm the details by email closer to the date.",
    },
    backToCalendar: "← Back to season calendar",
    inThisSessionEyebrow: "In this session",
    inThisSessionHeading: "One Cup, One Story",
    rsvpByEmail: "RSVP now",
    rsvpNamePlaceholder: "Your name",
    rsvpEmailPlaceholder: "Your email",
    rsvpDinnerLabel: "Staying for the optional dinner?",
    rsvpDinnerYes: "Yes",
    rsvpDinnerNo: "No",
    rsvpSubmitCta: "Send RSVP",
    rsvpSendingLabel: "Sending...",
    rsvpErrorMsg: "Something went wrong sending that. Please try again or email us directly.",
    rsvpSuccessHeading: "You're on the list!",
    rsvpSuccessMessage: "We'll confirm the details by email closer to the date.",
    seasonLaunchEyebrow: "Season Launch",
    seasonCloseEyebrow: "Season Close",
    thisEditionEyebrow: "This Edition",
    speakerPlaceholder: "A featured woman shares her story in her own words — this edition’s guest will be announced closer to the date.",
    venuePlaceholder: "Rotating venue in Central Bohemia — announced closer to the date",
    nextEditionLabel: "Next edition",
    list: [
      {
        slug: "confidence-and-boundaries",
        dateLabel: "Thursday, October 8, 2026 · 18:00–20:00",
        dateTag: "Oct 8, 2026",
        title: "Confidence & Boundaries",
        description: "Saying no without guilt. Negotiating what you're worth. Protecting your time like the professional asset it actually is. This month's One Cup, One Story guest is Veronika Kořínková, a lawyer and founder of Na vaší straně (\"On Your Side\"), working between Prague, Nymburk, and Poděbrady. Her days are spent helping people hold their ground, in contracts, in workplace disputes, in negotiations that don't always go the way they should. That work has taught her a lot about where boundaries get tested, and what it actually takes to hold one. She'll share her own story, then we'll open it up for a group conversation on saying no without over-explaining or apologizing for it, naming your worth out loud in negotiations and in daily work, and treating your time like it has real value, because it does. No pitches, no pressure. Just real conversation over coffee. Stay after for an optional dinner, priced at cost.",
        ticket: "490 CZK, early bird pricing available for early RSVPs",
      ...
      },
      {
        ...
        dateLabel: "Thursday, November 12, 2026 · 18:00–20:00",
        dateTag: "Nov 12, 2026",
      ...
      },
      {
        ...
        dateLabel: "Thursday, January 14, 2027 · 18:00–20:00",
        dateTag: "Jan 14, 2027",
        title: "Owning Your Next Chapter",
        description: "New-year vision setting — clarifying goals and the version of success you’re actually building toward.",
        ticket: "490 CZK",
      },
      {
        slug: "love",
        dateLabel: "Thursday, February 11, 2027 · 18:00–20:00",
        dateTag: "Feb 11, 2027",
        title: "Love",
        description: "Self-love as the foundation of leadership, love in partnerships and teams, and bringing heart back into how we lead and work.",
        ticket: "490 CZK",
      },
      {
        slug: "leading-with-purpose",
        dateLabel: "Thursday, March 11, 2027 · 18:00–20:00",
        dateTag: "Mar 11, 2027",
        title: "Leading With Purpose",
        description: "Timed around International Women’s Day — leadership styles, mentorship, and aligning your work with what actually matters to you. On women leading on their own terms, not by anyone else's playbook.",
        ticket: "490 CZK",
      },
      {
        slug: "owning-your-worth",
        dateLabel: "Thursday, April 8, 2027 · 18:00–20:00",
        dateTag: "Apr 8, 2027",
        title: "Owning Your Worth",
        description: "Imposter syndrome, credibility, and putting an actual number on what you know: negotiating your rate, pricing your work, and believing you deserve the ask. From believing you're the expert to being paid like one.",
        ticket: "490 CZK",
      },
      {
        slug: "ai-honestly",
        dateLabel: "Thursday, May 13, 2027 · 18:00–20:00",
        dateTag: "May 13, 2027",
        title: "AI, Honestly",
        description: "A candid discussion surfacing the real fears, doubts, and misconceptions about AI — a preview of the next season, and an opener for a follow-on online workshop.",
        ticket: "490 CZK",
      },
    ],
  },
  ...
  community: {
    ...
    members: [
      ...
      },
      {
        name: "Tamara Melissa",
        langs: "CZ · IT",
        role: "Body Psychotherapist & Women's Mentor · Cesta Ženy",
        bio: "You are not lost. You are standing at the threshold. Through body psychotherapy and ritual, I guide women through menopause and midlife into a more authentic, empowered version of themselves.",
        url: "https://www.tamaramelissa.cz/",
        urlLabel: "tamaramelissa.cz",
      },
    ],
  ...
  contact: {
    ...
    errorMsg: "Something went wrong sending that. Please try again or email us directly.",
  ...
  tenx: {
    ...
    optInTitleEmphasis: "10 days",
    optInSub: "Enter your details and receive the guide straight to your inbox, free.",
    namePlaceholder: "Your name",
    emailPlaceholder: "Your email",
    errorMsg: "Please fill in both fields.",
    submitErrorMsg: "Something went wrong sending that. Please try again in a moment.",
    sendingLabel: "Sending...",
