...
export const en: Translations = {
  ...
  events: {
    ...
    ctaBand: {
      ...
      emailNote: "RSVPs are currently handled by email — tap the button above to send Tamara your details. Automated confirmation and registration emails are coming soon.",
    },
    backToCalendar: "← Back to season calendar",
    inThisSessionEyebrow: "In this session",
    inThisSessionHeading: "One Cup, One Story",
    rsvpByEmail: "RSVP by email",
