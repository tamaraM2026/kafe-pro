...
export const en: Translations = {
  ...
  events: {
    hero: {
      ...
      metaLine: "Second Thursday of every month · 18:00–20:00 · English · September 2026 – May 2027",
    },
    whatsNew: {
      eyebrow: "What’s new",
    ...
    seasonDetails: [
      ...
      { label: "Season", value: "September 2026 – May 2027 (9 editions)" },
      { label: "Ticket", value: "490 CZK · early-bird 390 CZK for the first 15 RSVPs at the September 10 launch" },
      { label: "Dinner", value: "Optional add-on, priced at cost" },
    ],
    calendarEyebrow: "The season",
    calendarHeading: "The 2026–2027 season",
    calendarIntro: "Nine evenings, nine themes — chosen for women building careers, businesses, and lives without a template to follow.",
    ...
    list: [
      ...
      },
      {
        ...
        description: "Timed around International Women’s Day — leadership styles, mentorship, and leading on your own terms.",
        ticket: "490 CZK",
      },
      {
        slug: "owning-your-expertise",
        dateLabel: "Thursday, April 8, 2027 · 18:00–20:00",
        dateTag: "Apr 8, 2027",
        title: "Owning Your Expertise",
        description: "Imposter syndrome, credibility, and speaking up as the expert in the room.",
        ticket: "490 CZK",
      },
      {
        ...
        description: "Reflection on purpose — aligning work, values, and impact — plus a look ahead to next season.",
        ticket: "490 CZK",
      },
    ],
  },
